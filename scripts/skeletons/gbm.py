...
print("Classification Report for GBM (Training Set):")
print(classification_report(y_train, y_train_pred))

# Evaluate on Validation Set
y_val_pred = gbm_model.predict(X_val)
print("Classification Report for GBM (Validation Set):")
...
print("Classification Report for GBM (Test Set):")
...
plt.grid()
plt.legend(loc='best')
plt.savefig('../visualizations/learning_curve_gbm.png')
plt.close()
...
plt.title("Confusion Matrix Heatmap (GBM)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.savefig('../visualizations/confusion_matrix_gbm.png')
...
plt.grid()
plt.savefig('../visualizations/roc_curve_gbm.png')
...
plt.grid()
plt.legend()
plt.savefig('../visualizations/precision_recall_gbm.png')
