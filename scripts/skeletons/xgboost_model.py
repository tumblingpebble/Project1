...
xgb_model = XGBClassifier(
    ...
    scale_pos_weight=3, #handle class imbalance, adjust based on data 
    eval_metric='logloss',
    random_state=42
)
...
plt.grid()
plt.legend(loc='best')
plt.savefig('../visualizations/learning_curve_xgb.png')
plt.close()
...
plt.ylabel("Actual")
plt.savefig('../visualizations/confusion_matrix_xgb.png')
...
plt.grid()
plt.savefig('../visualizations/roc_curve_xgb.png')
...
plt.grid()
plt.legend()
plt.savefig('../visualizations/precision_recall_xgb.png')
